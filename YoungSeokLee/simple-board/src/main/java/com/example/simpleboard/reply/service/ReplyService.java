...
import com.example.simpleboard.curd.CRUDAbstractService;
...
/*    private final ReplyRepository replyRepository;
    ...
    public ReplyEntity create(
        ...
        var optionalPostEntity = postRepository.findFirstByIdAndStatusOrderByIdDesc(replyRequest.getPostId(),"REGISTERED");
